...
import '../../features/auth/api/data_sources/remote/fake_auth_remote_data_source_impl.dart'
    as _i123;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.factory<_i432.AuthRemoteDataSource>(
      () => const _i123.FakeAuthRemoteDataSourceImpl(),
    );
    ...
    gh.factory<_i550.ForgetPasswordCubit>(
      () => _i550.ForgetPasswordCubit(
        gh<_i483.ForgetPasswordUseCase>(),
        gh<_i40.VerifyResetOtpUseCase>(),
